...
const CHANGELOG_EN = 'Fixed a bug that was blocking sign-in for everyone, and fixed deleting orders from history.';
const CHANGELOG_KU = 'هەڵەیەک چاکرایەوە کە ڕێی چوونەژوورەوەی هەموو کەسێکی گرتبوو، هەروەها سڕینەوەی داواکاری لە مێژووش چاکرایەوە.';
