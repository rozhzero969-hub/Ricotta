...
const CHANGELOG_EN = 'The Devices list now only shows devices that are logged in. Devices that log out are removed from it.';
const CHANGELOG_KU = 'لیستی ئامێرەکان ئێستا تەنها ئەو ئامێرانە نیشان دەدات کە چووەتە ژوورەوە. ئەو ئامێرانەی دەردەچن لە لیستەکە دەسڕدرێنەوە.';
