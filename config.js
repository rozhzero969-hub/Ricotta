...
const CHANGELOG_EN = 'Admins can now log out other devices or send them a refresh popup from the Devices tab. Better mobile layout.';
const CHANGELOG_KU = 'بەڕێوەبەر ئێستا دەتوانێت لە بەشی ئامێرەکان ئامێرەکانی تر دەربکات یان داوای نوێکردنەوەیان بۆ بنێرێت. دیزاینی مۆبایل باشتر کرا.';
