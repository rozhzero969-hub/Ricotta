...
const CHANGELOG_EN = 'Each supplier can now have its own order reminder. Reminder notifications are fixed, and logged-out devices now leave the logged-in list right away.';
const CHANGELOG_KU = 'ئێستا هەر دابینکەرێک دەتوانێت بیرخەرەوەی داواکاری تایبەت بە خۆی هەبێت. ئاگادارکردنەوەی بیرخەرەوەکان چاک کرا، و ئامێری دەرکراو یەکسەر لە لیستی چووەتە ژوورەوە نامێنێت.';
