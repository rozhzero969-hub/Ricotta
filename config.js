...
const CHANGELOG_EN = 'You can now delete or re-order past history entries, and the supplier field stays selected when you add several items for the same supplier in a row.';
const CHANGELOG_KU = 'ئێستا دەتوانیت داواکارییە کۆنەکان بسڕیتەوە یان دووبارە داواکەیت، هەروەها کاتێک چەند کاڵا بۆ یەک دابینکەر زیاد دەکەیت دابینکەرەکە هەڵبژێردراو دەمێنێتەوە.';
