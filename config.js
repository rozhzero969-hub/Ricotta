...
const CHANGELOG_EN = 'Adding and editing suppliers and items now happens in a popup that shows what you are editing, and the new Record tab lists every add, edit and delete with the date and time.';
const CHANGELOG_KU = 'ئێستا زیادکردن و دەستکاریکردنی دابینکەر و کاڵا لە پەنجەرەیەکی بچووکدا دەکرێت کە پیشانی دەدات چی دەستکاری دەکەیت، و بەشی تۆمار هەموو زیادکردن و دەستکاریکردن و سڕینەوەیەک لەگەڵ بەروار و کات پیشان دەدات.';
