...
const CHANGELOG_EN = 'Devices that log in are now tracked (with a nickname you can set) so admins can see who logged in and when, in Settings under Cloud setup.';
const CHANGELOG_KU = 'ئێستا ئامێرەکانی چوونەژوورەوە تۆمار دەکرێن (لەگەڵ نازناوێک کە دەتوانیت دایبنێیت)، بۆ ئەوەی بەڕێوەبەر بزانێت کێ کەی چووەتە ژوورەوە، لە ڕێکخستندا لەژێر ڕێکخستنی هەور.';
