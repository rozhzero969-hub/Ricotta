...
const CHANGELOG_EN = 'The app got a visual refresh with smoother animations throughout, and the update notification button now lets you write your own message each time instead of a fixed one.';
const CHANGELOG_KU = 'ڕووکاری ئەپەکە نوێکرایەوە لەگەڵ جووڵەی نەرمتر لە هەموو شوێنێک، ئێستا لە کاتی ناردنی ئاگادارکردنەوەی نوێکاری دەتوانیت هەر جارێک پەیامەکەت بە خۆت بنووسیت.';
